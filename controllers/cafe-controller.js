var functionalityApp = angular.module("GRASSPApp");
var cafeHelsingborg = angular.module("cafeApp");

functionalityApp.controller('FirstController', ['$scope', '$firebaseAuth', function ($scope, $firebaseAuth) {
...
//
functionalityApp.controller('SignUpController', ['$scope', '$firebaseAuth', '$location', function ($scope, $firebaseAuth, $location) {
...
functionalityApp.controller('LogInController', ['$scope', '$firebaseAuth', '$location', function ($scope, $firebaseAuth, $location) {
...
functionalityApp.controller('AuthCtrl', ['$scope', '$location', '$firebaseAuth','facebookService', function ($scope, $location, $firebaseAuth) {
    $firebaseAuth().$onAuthStateChanged(function (user) {
        if (user) {
            $scope.user = user;
        } else {
...
functionalityApp.controller('getWeatherCtrl', ['$scope', 'weatherService', function ($scope, weatherService) {
